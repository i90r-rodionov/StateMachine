...
@Component("createTaskInPegaErrorAction")
public class CreateTaskInPegaErrorAction extends BaseAction {

    private final CheckService service;

    public CreateTaskInPegaErrorAction(StateHolder stateHolder, CheckService service) {
        super(stateHolder);
